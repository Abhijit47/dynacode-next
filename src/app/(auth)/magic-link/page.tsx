...
export default function MagicLinkPage() {
  return (
    <Card className='z-1 w-full border-none shadow-md sm:max-w-md'>
      ...
      <CardHeader>
        <CardTitle className='text-2xl'>Login with Magic Link</CardTitle>
        <CardDescription className='text-sm md:text-base'>
          Enter your email address below, and we&apos;ll send you a magic link
          to access your account without a password.
        </CardDescription>
      </CardHeader>
