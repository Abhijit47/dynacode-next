          ...
          <CardContent className='flex flex-col h-full w-full items-center justify-center gap-4 p-4'>
            ...
            <CardDescription className={'max-w-4xl mx-auto'}>
              <p className='text-center text-lg md:text-xl'>
                Discover our desktop application development services, offering
                tailored solutions for Windows, macOS, and Linux platforms.
                Enhance your business with robust and user-friendly desktop
                applications.
              </p>
            </CardDescription>
            <CoolMode
