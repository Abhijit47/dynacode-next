          ...
          <CardContent className='flex flex-col h-full w-full items-center justify-center gap-4 p-4'>
            ...
            <CardDescription className={'max-w-4xl mx-auto'}>
              <p className='text-center text-lg md:text-xl'>
                Welcome to DYNACODE, your premier mobile development partner. We
                specialize in creating powerful iOS and Android applications
                that deliver exceptional user experiences and drive business
                growth. Let&apos;s build your mobile success together.
              </p>
            </CardDescription>
            <CoolMode
            // options={{
